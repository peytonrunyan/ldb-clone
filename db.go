...
// For this first implementation, you don’t need to worry about efficiency;
// just get something working however you can (for example, it’s acceptable to
// <<have a linear time Get, or to sort on every Put call).
